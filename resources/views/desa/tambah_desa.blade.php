        ...
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-header">
                    <h2 class="font-weight-bold text-center">Tambah Desa</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('tambahDesaAksi') }}" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="desa" class="form-control" placeholder="Masukkan nama desa" value="{{ old('desa') }}">
